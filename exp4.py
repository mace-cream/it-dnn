...
Need: File './val.txt' from [http://dl.caffe.berkeleyvision.org/caffe_ilsvrc12.tar.gz]
...
# Here we use ResNet50 as an example, other networks could be validated using the same way
...
img_size = 224  #224 for resnet & VGG16 & VGG19, 299 for Xception & InceptionV3 & InceptionResNetV2
